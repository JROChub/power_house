...
const modes = {
  ...
  sfcs: {
    ...
    description:
      "Inspect the v0.3.21 private VM gate: bitwise rows, signed and unsigned comparisons, non-equality/order branches, and partial-width memory semantics.",

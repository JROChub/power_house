...
| Real-model scope | 3 retained MLPs plus 1 browser RBF example, 2 families, 1 dataset, ONNX Runtime and CKODMK browser candidate generation, 1 physical CPU; external and second-device evidence remain absent |
